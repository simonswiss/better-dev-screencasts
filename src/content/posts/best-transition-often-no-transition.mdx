...
<Image image="/src/images/posts/best-transition-often-no-transition/cross-dissolve.jpg" altText="Screenshot of video editing software showing a cross-fade transition" caption="A basic cross-disolve transition" />
...
<Image image="/src/images/posts/best-transition-often-no-transition/j-cut-unlink.jpg" altText="DaVinci Resolve screenshot showing the &#x22;link clips&#x22; in timeline" caption="Unlink the audio and video clips" />

**2. Move the "split" point** of either the audio or video track to achieve your desired effect. Adjust the clips as you see fit!

<Image image="/src/images/posts/best-transition-often-no-transition/j-cut-example.jpg" altText="DaVinci Resolve timeline showing a J-Cut" caption="Adjust the clips as you see fit!" />
...
<Image image="/src/images/posts/best-transition-often-no-transition/l-cut-example.jpg" altText="DaVinci Resolve timeline showing an L-Cut" caption="L-cut to the rescue!" />
